...
const Classic = dynamic(() => import('@/components/layouts/types/classic'));
const Standard = dynamic(() => import('@/components/layouts/types/standard'));
const Modern = dynamic(() => import('@/components/layouts/types/modern'));
const Minimal = dynamic(() => import('@/components/layouts/types/minimal'));
const Compact = dynamic(() => import('@/components/layouts/types/compact'));
